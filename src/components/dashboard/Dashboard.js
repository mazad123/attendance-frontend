...
function Dashboard() {
  ...
  const allNotifications = [
    ...
    ...getTaggedUsers.map(item => ({
      ...item,
      type: 'tagged',
      createdAt: item.changeRequest?.createdAt // normalize here
    })),
            ...
            <h1 className="user-name-wrap">
              ...
              <div className="dropdown notifications user-notify-data">
                <NavLink className="app-nav__item" to="#" data-bs-toggle="dropdown" aria-label="Show notifications" aria-expanded="false">
                  ...
                  {absentEmployees.length > 0 || wfhTeamListEmployees.length > 0 || pendingRelievingForm.length > 0 || getTaggedUsers.length > 0 ? <img src={NotificationBell} alt="notification-icon" style={{ width: '37px' }} /> : <i className="fa fa-bell-o fa-lg" style={{ color: 'black' }}></i>}
                </NavLink>
                <ul className="app-notification dropdown-menu dropdown-menu-end dropdown-menu-right" x-placement="bottom-end" style={{ width: '245px' }}>
                  ...
                  <div className="app-notification__content">
                    {allNotifications.length > 0 && allNotifications.map((data, i) => (
                      <li key={i}>
                          ...
                          <div>
                            ...
                            {data.type === 'tagged' && (
                              <NavLink to={
                                ...
                                <p className="app-notification__meta">{moment(data.changeRequest.createdAt).fromNow()}</p>
                              </NavLink>
                            )}
                            {data.type === 'relieving' && (
